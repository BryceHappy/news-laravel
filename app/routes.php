...
Route::group(array('prefix' => 'admin', 'before' => 'auth'), function()
{
    ...
    Route::post('histories/{histories}/delete', 'AdminHistoriesController@postDelete');
    Route::controller('histories', 'AdminHistoriesController');
...
Route::post('/{id}', 'BlogController@postView');
